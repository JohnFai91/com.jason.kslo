...
public class ChangelogActivity extends AppCompatActivity {
    ...
    ArrayList<ChangelogParseItem> parseItems = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (updated != null && updated.equals("true")){
            Toast.makeText(this,getString(R.string.UpdatedSuccesfully),Toast.LENGTH_SHORT)
                    .show();
        }
        ...
        public void run() {
            ...
            for (int i = versionCode + 1; i > 0 ; i--) {
                if (i == 1){
                    ...
                    version = "1.0.6-beta\n" +
                            "(Test state: 27-2-2021," +
                            "\nFull state: 28-2-2021)\n" +
                            "(UI and code update)\n" +
                ...
                parseItems.add(new ChangelogParseItem(descL,descR,version));
            }
        }
    }
}