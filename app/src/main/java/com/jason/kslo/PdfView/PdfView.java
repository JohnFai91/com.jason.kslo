    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                // Output stream
                OutputStream output = new DataOutputStream(new FileOutputStream("sdcard/Android/data/com.jason.kslo/tmp.pdf"));
        ...
        protected void onPostExecute(String file_url) {
            ...
            String filepath = ("/sdcard/Android/data/com.jason.kslo/tmp.pdf");
