...
import com.jason.kslo.parseContent.defaultParseContent.activity.DetailedImageActivity;
import com.jason.kslo.parseContent.defaultParseContent.activity.Detailed_Gallery;
...
public class ParseAdapterForDetailedWebsite extends RecyclerView.Adapter<ParseAdapterForDetailedWebsite.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(view.getContext(), Detailed_Gallery.class);
            intent.putExtra("detailUrl", parseItems.get(getAdapterPosition()).getDetailUrl());
