...
import com.jason.kslo.ParseContent.DefaultParseContent.ParseAdapter.ParseAdapterForDetailedLatestNews;
        ...
        try {
            ...
            try {
                for (int i = 0; i < size; i++) {
                    ...
                    parseSecondItem.add(new SecondParseItem(bulletPoints));
                }
